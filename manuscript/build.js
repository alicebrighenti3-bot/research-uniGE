  ...
  sections: [
    {
      ...
      children: [
        ...
        p("Working title — draft manuscript v0.5", { italic: true, align: AlignmentType.CENTER, size: 22, spacingAfter: 100 }),
...
Packer.toBuffer(doc).then((buffer) => {
  fs.writeFileSync("/home/user/research-uniGE/manuscript/APS_Cancer_Anticoagulation_Manuscript_v0.5.docx", buffer);
  console.log("done");
});
